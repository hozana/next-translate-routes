 ...
 */
var withTranslateRoutes = function (_a) {
  var _b = _a.translateRoutes,
    _c = _b === void 0 ? {} : _b,
    debug = _c.debug,
    routesDataFileName = _c.routesDataFileName,
    customRoutesTree = _c.routesTree,
    pagesDirectory = _c.pagesDirectory,
    nextConfig = __rest(_a, ['translateRoutes'])
  if (!nextConfig.i18n) {
    throw new Error(
  ...
  var pagesDir = ['pages', 'src/pages', 'app/pages', 'intergrations/pages', pagesDirectory].find(function (dirPath) {
    return dirPath && fs_1.default.existsSync(path_1.default.join(process.cwd(), dirPath))
  })
  if (!pagesDir) {
    throw new Error('[next-translate-routes] - No pages folder found.')
  }
  var pagesPath = path_1.default.join(process.cwd(), pagesDir, '/')
  var _d = nextConfig.i18n,
    defaultLocale = _d.defaultLocale,
    _e = _d.locales,
    locales = _e === void 0 ? [] : _e,
    _f = nextConfig.pageExtensions,
    pageExtensions = _f === void 0 ? ['js', 'jsx', 'ts', 'tsx'] : _f
  var routesTree =
    customRoutesTree ||
    (0, parsePages_1.parsePages)({
      directoryPath: pagesPath,
      pageExtensions: pageExtensions,
      routesDataFileName: routesDataFileName,
    })
  // TODO: validateRoutesTree(routesTree)
  var _g = (0, getRouteBranchReRoutes_1.getRouteBranchReRoutes)({
      locales: locales,
      routeBranch: routesTree,
      defaultLocale: defaultLocale,
    }),
    redirects = _g.redirects,
    rewrites = _g.rewrites
  ...
  return __assign(__assign({}, nextConfig), {
    webpack: function (conf, options) {
      var config = typeof nextConfig.webpack === 'function' ? nextConfig.webpack(conf, options) : conf
      if (!config.module) {
        config.module = {}
      }
      ...
      config.module.rules.push({
        test: new RegExp('_app\\.('.concat(pageExtensions.join('|'), ')$')),
        use: {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              return [
                2 /*return*/,
                __spreadArray(__spreadArray([], __read(sortedRedirects), false), __read(existingRedirects), false),
              ]
          }
        })
      })
          ...
          switch (_b.label) {
            ...
            case 2:
              ...
              if (Array.isArray(existingRewrites)) {
                return [
                  2 /*return*/,
                  __spreadArray(__spreadArray([], __read(existingRewrites), false), __read(sortedRewrites), false),
                ]
              }
              return [
                2 /*return*/,
                __assign(__assign({}, existingRewrites), {
                  afterFiles: __spreadArray(
                    __spreadArray([], __read(existingRewrites.afterFiles || []), false),
                    __read(sortedRewrites),
                    false,
                  ),
                }),
              ]
